...
import implementacionMapHashAbierto.MapSeparateChaining;
import implementacionMapHashCerrado.MapOpenAddressing;
...
public class MapTest {
	...
	private Map<Integer, Integer> getMapeo() {
		...
		return new MapOpenAddressing<Integer, Integer>();
